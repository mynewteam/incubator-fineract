...
//days_in_Arrears
	private Integer client_account_no;
	private Integer account_number;
	private double loan_outstanding;
	private Date overdue_since_date_derived;
	private Integer days_in_arrears;

	public LoanArriaClassifyData(Integer client_account_no, Integer account_number, double loan_outstanding,
	...
	public Integer getClient_account_no() {
		return client_account_no;
	}

	public void setClient_account_no(Integer client_account_no) {
		this.client_account_no = client_account_no;
	}
