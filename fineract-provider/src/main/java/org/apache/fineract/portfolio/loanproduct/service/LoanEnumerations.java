...
public class LoanEnumerations {
	...
	public static EnumOptionData loanTermFrequencyType(final PeriodFrequencyType type) {
		...
		case YEARS:
			...
			break;
		default:
			optionData = new EnumOptionData(PeriodFrequencyType.INVALID.getValue().longValue(),
	...
	public static EnumOptionData repaymentFrequencyDayOfWeekType(final DayOfWeekType type) {
		final String codePrefix = "repaymentFrequency.";
		EnumOptionData optionData = new EnumOptionData(type.getValue().longValue(), codePrefix + type.getCode(),
				type.toString());
	...
	public static EnumOptionData amortizationType(final AmortizationMethod amortizationMethod) {
		...
		case EQUAL_PRINCIPAL:
			...
			break;
		default:
			optionData = new EnumOptionData(AmortizationMethod.INVALID.getValue().longValue(),
	...
	public static EnumOptionData interestType(final InterestMethod type) {
		...
		switch (type) {
		case FLAT:
			optionData = new EnumOptionData(InterestMethod.FLAT.getValue().longValue(), InterestMethod.FLAT.getCode(),
					"Flat");
			break;
		case DECLINING_BALANCE:
			...
			break;
		default:
			optionData = new EnumOptionData(InterestMethod.INVALID.getValue().longValue(),
					InterestMethod.INVALID.getCode(), "Invalid");
			break;
		}
		return optionData;
	}
	...
	public static LoanTransactionEnumData transactionType(final LoanTransactionType type) {
		...
		case ACCRUAL:
			...
			break;
		case CHANGE_SUBTYPE:
			optionData = new LoanTransactionEnumData(LoanTransactionType.CHANGE_SUBTYPE.getValue().longValue(),
					LoanTransactionType.CHANGE_SUBTYPE.getCode(), "Change subtype");
			break;
	...
	public static LoanStatusEnumData status(final LoanStatus status) {
		LoanStatusEnumData optionData = new LoanStatusEnumData(LoanStatus.INVALID.getValue().longValue(),
				LoanStatus.INVALID.getCode(), "Invalid");
		switch (status) {
		case INVALID:
			optionData = new LoanStatusEnumData(LoanStatus.INVALID.getValue().longValue(), LoanStatus.INVALID.getCode(),
					"Invalid");
			break;
		case SUBMITTED_AND_PENDING_APPROVAL:
			...
			break;
		case APPROVED:
			optionData = new LoanStatusEnumData(LoanStatus.APPROVED.getValue().longValue(),
					LoanStatus.APPROVED.getCode(), "Approved");
			break;
		case ACTIVE:
			optionData = new LoanStatusEnumData(LoanStatus.ACTIVE.getValue().longValue(), LoanStatus.ACTIVE.getCode(),
					"Active");
			break;
		case REJECTED:
			optionData = new LoanStatusEnumData(LoanStatus.REJECTED.getValue().longValue(),
		...
		case CLOSED_RESCHEDULE_OUTSTANDING_AMOUNT:
			...
			break;
		case OVERPAID:
			optionData = new LoanStatusEnumData(LoanStatus.OVERPAID.getValue().longValue(),
	...
	public static EnumOptionData preCloseInterestCalculationStrategy(
		...
		case TILL_PRE_CLOSURE_DATE:
			optionData = new EnumOptionData(
					LoanPreClosureInterestCalculationStrategy.TILL_PRE_CLOSURE_DATE.getValue().longValue(),
					LoanPreClosureInterestCalculationStrategy.TILL_PRE_CLOSURE_DATE.getCode(), "Till preclose Date");
			break;
		case TILL_REST_FREQUENCY_DATE:
			optionData = new EnumOptionData(
					LoanPreClosureInterestCalculationStrategy.TILL_REST_FREQUENCY_DATE.getValue().longValue(),
