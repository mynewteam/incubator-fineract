...
public final class CalculateLoanScheduleQueryFromApiJsonHelper {
	...
	final Set<String> supportedParameters = new HashSet<>(Arrays.asList(LoanApiConstants.idParameterName,
			...
			LoanApiConstants.loanTypeParameterName, LoanApiConstants.calendarIdParameterName,
			LoanApiConstants.productIdParameterName, LoanApiConstants.accountNoParameterName,
			...
			LoanApiConstants.transactionProcessingStrategyIdParameterName, LoanApiConstants.principalParamName,
			...
			LoanApiConstants.landCollateralParameterName, LoanApiConstants.syncDisbursementWithMeetingParameterName,
			...
			LoanApiConstants.repaymentFrequencyDayOfWeekTypeParameterName, LoanApiConstants.isTopup,
			LoanApiConstants.loanIdToClose, LoanApiConstants.datatables,
			LoanApiConstants.loanAccountIdParam,
	...
	public void validate(final String json) {
		...
		final Integer repaymentEvery = this.fromApiJsonHelper.extractIntegerWithLocaleNamed(repaymentEveryParameterName,
				element);
		...
		final Integer repaymentEveryType = this.fromApiJsonHelper
				.extractIntegerWithLocaleNamed(repaymentEveryFrequencyTypeParameterName, element);
		...
		validateSelectedPeriodFrequencyTypeIsTheSame(dataValidationErrors, loanTermFrequency, loanTermFrequencyType,
		...
		if (this.fromApiJsonHelper.parameterExists(repaymentsStartingFromDateParameterName, element)) {
			repaymentsStartingFromDate = this.fromApiJsonHelper
	...
	private void validateRepaymentsStartingFromDateIsAfterDisbursementDate(
			final List<ApiParameterError> dataValidationErrors, final LocalDate expectedDisbursementDate,
