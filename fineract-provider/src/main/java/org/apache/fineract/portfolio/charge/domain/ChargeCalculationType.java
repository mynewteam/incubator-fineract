...
public enum ChargeCalculationType {
    ...
    PERCENT_OF_OUSTANDING_AMOUNT(6,"chargeCalculationType.percent.of.outstanding.amount");
    ...
    public static Object[] validValuesForLoan() {
        return new Integer[] {
                ...
                ,ChargeCalculationType.PERCENT_OF_OUSTANDING_AMOUNT.getValue()
        };
    }
    ...
    public static ChargeCalculationType fromInt(final Integer chargeCalculation) {
        ...
        switch (chargeCalculation) {
            ...
            break;
            case 6:
                chargeCalculationType = PERCENT_OF_OUSTANDING_AMOUNT;
            break;
        }
    ...
    public boolean isPercentageOfOutstandingAmount(){
        return this.value.equals(ChargeCalculationType.PERCENT_OF_OUSTANDING_AMOUNT.getValue());
    }
}