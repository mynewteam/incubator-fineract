...
public class ClientWritePlatformServiceJpaRepositoryImpl implements ClientWritePlatformService {
    ...
    public ClientWritePlatformServiceJpaRepositoryImpl(final PlatformSecurityContext context,
            ...
            final OfficeRepositoryWrapper officeRepositoryWrapper, final VillageKhmerRepositoryWrapper villageKhmerRepositoryWrapper,
            ...
            final LoanRepositoryWrapper loanRepositoryWrapper, final SavingsAccountRepositoryWrapper savingsRepositoryWrapper,
    ...
    public CommandProcessingResult createClient(final JsonCommand command) {
        ...
        try {
            ...
            final Client newClient = Client.createNew(currentUser, clientOffice, villageKhmer, clientParentGroup, staff, savingsProductId,
                    gender, clientType, clientClassification, legalFormValue, command);
