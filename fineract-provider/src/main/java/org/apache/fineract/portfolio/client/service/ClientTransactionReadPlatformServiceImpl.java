...
public class ClientTransactionReadPlatformServiceImpl implements ClientTransactionReadPlatformService
{
	...
	private static final class ClientTransactionMapper implements RowMapper<ClientTransactionData>
	{
		...
		@Override
		public ClientTransactionData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum)
			throws SQLException
		{
			...
			return ClientTransactionData.create(id, officeId, officeName, transactionType, date, currency,
				paymentDetailData, amount,
	...
	public ClientTransactionData retrieveTransaction(Long clientId, Long transactionId)
	{
		try
		{
			...
			return this.jdbcTemplate.queryForObject(sql, this.clientTransactionMapper, new Object[]
			{
