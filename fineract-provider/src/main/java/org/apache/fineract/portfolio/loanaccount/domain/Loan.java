...
public class Loan extends AbstractPersistableCustom<Long> {
	...
	private BigDecimal calculateAmountPercentageAppliedTo(final LoanCharge loanCharge) {
		...
		// logger.info("Sothea Working On Class
		// Loan::calculateAmountPercentageAppliedTo(final LoanCharge loanCharge) " +
	...
	private void addUpdateIncomeAndAccrualTransaction(
			...
			LoanInterestRecalcualtionAdditionalDetails compoundingDetail, LocalDate lastCompoundingDate,
			AppUser currentUser, LoanTransaction existingIncomeTransaction,
