...
public class ClientFamilyMembersApiResources {
	...
	public String getFamilyMember(@Context final UriInfo uriInfo,
	...
	public String getFamilyMembers(@Context final UriInfo uriInfo, @PathParam("clientId") final long clientId) {
		...
		final Collection<ClientFamilyMembersData> familyMembers = this.readPlatformService
	...
	@Consumes({ MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_JSON })
	public String updateClientFamilyMembers(@PathParam("familyMemberId") final long familyMemberId,
	...
	@Consumes({ MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_JSON })
	public String deleteClientFamilyMembers(@PathParam("familyMemberId") final long familyMemberId,
			final String apiRequestBodyAsJson) {
