...
public final class LoanScheduleModelDisbursementPeriod implements LoanScheduleModelPeriod
{
	...
	public static LoanScheduleModelDisbursementPeriod disbursement(
		...
		final BigDecimal chargesDueAtTimeOfDisbursement)
	{
		return new LoanScheduleModelDisbursementPeriod(null, disbursementDate, principalDisbursed,
	...
	@Override
	public void addOutstandingAmount(@SuppressWarnings("unused") Money outstanding)
	{
		return;
	}
