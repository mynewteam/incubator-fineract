...
public class ShareProductWritePlatformServiceJpaRepositoryImpl implements ShareProductWritePlatformService {
    ...
    public CommandProcessingResult createShareProductDividend(final Long productId, final JsonCommand jsonCommand) {
        try {
            ...
            final ShareProductDividendPayOutDetails dividendPayOutDetails = this.shareProductDividendAssembler
                    .calculateDividends(productId, dividendAmount, dividendPeriodStartDate, dividendPeriodEndDate);
            if (dividendPayOutDetails == null) {
                throw new DividentProcessingException("eligible.shares.not.found",
    ...
    private Map<BusinessEventNotificationConstants.BUSINESS_ENTITY, Object> constructEntityMap(
            final BusinessEventNotificationConstants.BUSINESS_ENTITY entityEvent, Object entity) {
