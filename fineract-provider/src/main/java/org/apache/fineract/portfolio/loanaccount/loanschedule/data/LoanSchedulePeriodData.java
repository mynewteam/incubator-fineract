...
public class LoanSchedulePeriodData
{
		...
		final BigDecimal totalInstallmentAmountForPeriod)
	{
		...
		return new LoanSchedulePeriodData(periodNumber, fromDate, dueDate, obligationsMetOnDate, complete,
		...
		final BigDecimal penaltyChargesPaid)
	{
		...
		return new LoanSchedulePeriodData(loanSchedulePeriodData.period, loanSchedulePeriodData.fromDate,
			loanSchedulePeriodData.dueDate,
			loanSchedulePeriodData.obligationsMetOnDate, complete, loanSchedulePeriodData.principalOriginalDue,
			principalPaid,
